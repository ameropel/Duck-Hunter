...
[AddComponentMenu("Splines/Spline Controller_Menu")]
[RequireComponent(typeof(SplineInterpolator_Menu))]
public class SplineController_Menu : MonoBehaviour
{
	...
	SplineInterpolator_Menu mSplineInterp;
	...
	void OnDrawGizmos()
	{
		...
		SplineInterpolator_Menu interp = GetComponent(typeof(SplineInterpolator_Menu)) as SplineInterpolator_Menu;
	...
	void Start()
	{			
		mSplineInterp = GetComponent(typeof(SplineInterpolator_Menu)) as SplineInterpolator_Menu;
	...
	void SetupSplineInterpolator(SplineInterpolator_Menu interp, Transform[] trans)
	{
		interp.Reset();
